...
int main()
{
	...
	cout << "Enter the string for showing input member function def_str:";
	//def_str.scan_String();

	cin >> def_str;
	cout << "Entered string def_str is :";
	cout << def_str;
	//demonstrating parametarised constructor result

	cout << endl << "Parameterised constructer string para_str  :";
	para_str.print_String();
	//demonstarting copy constructor result

	cout << endl << "copy constructor string  has copy_str :";
	...
	cout << endl << "concatinating copystr:" << copy_str << " and deep_str " << deep_str;
	...
	if (copy_str < concat_str) {
		cout << "copy_str is smaller";
	}
